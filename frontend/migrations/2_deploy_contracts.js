...
const createStakingPool = async(stakingManager, stakeTokenAddress, weighting) => {
  console.log(`Create staking pool: ${stakeTokenAddress} ...`);
  return await stakingManager.createPool(stakeTokenAddress, weighting);
}
...
module.exports = async function(deployer, network, accounts) {
  ...
  await createStakingPool(StakingManager_deployed, LP1Address, 50);
  await createStakingPool(StakingManager_deployed, LP2Address, 30);
  await createStakingPool(StakingManager_deployed, LP3Address, 20);
